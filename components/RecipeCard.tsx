...
export default function RecipeCard({ recipe }: RecipeCardProps) {
    ...
    return (
        <div className="group bg-white rounded-3xl overflow-hidden border border-gray-100 shadow-card card-hover-effect flex flex-col justify-between h-full">
            <div>
                ...
                <div className="p-5">
                    ...
                    {/* Recipe Title */}
                    <h3 className="font-extrabold text-gray-900 text-lg leading-snug mb-3 group-hover:text-brand-600 transition-colors line-clamp-1">
                    ...
                    {/* Ratings Row matching reference image format: Stars (4.9) (2,140) */}
                    <div className="flex items-center justify-between text-xs mb-2">
                        <div className="flex items-center gap-1 text-amber-500">
                            ...
                            <span className="font-bold text-gray-900 mr-1">{recipe.rating_avg.toFixed(1)}</span>
                        </div>
